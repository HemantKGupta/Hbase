 ...
 * First create table using command: create 'mytesting', {NAME => 't', VERSIONS => 1}
 */
public class Recipe3 {
	...
	static class HourlyImporter extends
	    ...
	    // column family name
	    static byte[] family = Bytes.toBytes("t");
	...
	public static void main(String[] args) throws Exception {
		...
		arg[0]="mytesting";
		//arg[1]="hdfs://localhost:9000/hly-temp-normal.txt";
		arg[1]= "/media/Hemant/GitRepos/Hbase/MRJobToGenerateHFile/hly-temp-normal.txt";
		//arg[2]= "out";
		arg[2]= "hdfs://localhost:9000/outhfile";
		Job job = createSubmittableJob(conf, arg);
